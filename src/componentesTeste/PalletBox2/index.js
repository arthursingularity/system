import "./palletbox2.css";
import React, { useEffect, useState } from 'react';

function PalletBox2({ values, onInputChange, onClose, isVisible, descricao, togglePieceTableVisibility }) {
    ...
    return (
        <div className="flex justify-center items-center z-50">
            <div className={`bg-stam-bg-3 palletBoxVB absolute border border-stam-border p-4 ${animationClass}`}>
